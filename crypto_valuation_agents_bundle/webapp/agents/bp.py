...
def _fetch_dl_perps_volume_30d() -> float:
    """Sum last 30 daily perps volume entries from DefiLlama derivatives."""
    try:
...
def run() -> dict:
    ...
    # ── Volume / fee data ────────────────────────────────────────────────────
    perps_30d = _fetch_dl_perps_volume_30d()
